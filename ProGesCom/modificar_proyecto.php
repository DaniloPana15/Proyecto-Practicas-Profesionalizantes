...
// Verificamos si hay un ID para editar
if (isset($_GET['id'])) {
    $id = $_GET['id'];

    // Consultamos el proyecto con el ID específico
...
// Procesamos el formulario de modificación
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE proyectos SET nombre='$nombre', contrato='$contrato', propuesta='$propuesta', monto='$monto', estado='$estado' WHERE id=$id";
